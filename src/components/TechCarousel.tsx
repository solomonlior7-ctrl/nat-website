  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "linear-gradient(90deg, #0b0f19, transparent)" }}
      />
      {/* Fade right */}
      <div
      ...
      <div className="flex animate-marquee py-4" style={{ width: "max-content" }}>
        {doubled.map((item, i) => (
          <div
            key={i}
            className="flex items-center gap-2.5 mx-3 px-5 py-2.5 rounded-xl shrink-0 cursor-default select-none"
            style={{

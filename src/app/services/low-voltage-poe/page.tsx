  ...
  return (
    <>
      ...
      <section className="py-20 bg-ivory">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="font-sans text-gold text-xs font-bold uppercase tracking-[0.18em] mb-3">What Is PoE?</p>
              <h2 className="text-3xl font-semibold text-ink mb-6 tracking-tight">{field(c, "poe_title", "One Cable. Two Functions.")}</h2>
      ...
      <section className="py-20 bg-ivory-deep">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-semibold text-ink mb-4 tracking-tight">Benefits of PoE</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((b) => (
              <div key={b.title} className="glass-card rounded-xl p-6">
                ...
                <p className="font-sans text-ink-muted text-sm leading-relaxed">{b.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-ivory">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-semibold text-ink mb-4 tracking-tight">Applications</h2>
            <p className="font-sans text-ink-soft">PoE solutions are suitable for a wide range of environments and industries.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {applications.map((app) => (
              <div key={app} className="glass-card rounded-xl p-6 text-center">
                <span className="font-sans font-semibold text-ink text-sm">{app}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-ivory-deep">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-semibold text-ink mb-4 tracking-tight">Supporting Technologies</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {technologies.map((t) => (
              <div key={t.title} className="glass-card rounded-xl p-6">
                <h3 className="font-semibold text-ink mb-2">{t.title}</h3>
                <p className="font-sans text-ink-muted text-sm leading-relaxed">{t.desc}</p>
              </div>
            ))}
          </div>
        </div>

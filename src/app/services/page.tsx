...
const services = [
  {
    ...
    summary: "Enterprise connectivity, cloud solutions, structured cabling, network architecture, managed services, and security resilience.",
  ...
  },
  {
    ...
    summary: "Power over Ethernet systems that deliver data and power through a single cable — simplifying deployment and reducing infrastructure costs.",
  ...
  },
  {
    ...
    summary: "Complete visibility, protection, and control across networks, cloud, identity, IoT, access control, and physical surveillance.",
  ...
  },
  {
    ...
    summary: "Intelligent automation for lighting, climate, security, shading, and connected devices — delivering comfort, efficiency, and control.",
  ...
  },
  {
    ...
    summary: "Intelligent fuel dispensing, real-time monitoring, RFID authentication, tank-level visibility, and automated reporting for fleets and facilities.",
...
export default function ServicesPage() {
  return (
    <>
      <Hero
        title="Our Services"
        headline="Integrated Technology Services Built Around Your Needs"
        copy="Five specialised service areas — each designed to connect seamlessly across infrastructure, security, automation, and operations."
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-600 text-lg leading-relaxed">
            Our services are designed to work as a connected ecosystem. Whether you need a single
            service or a complete technology environment, NAT Technologies delivers integrated
            solutions that communicate, complement, and evolve together.
          </p>
        </div>
      </section>
      ...
      <CTASection
        ...
        subtext="Tell us what you need and we'll design a solution that fits."
        primaryCta={{ label: "Discuss Your Project", href: "/contact" }}
      />
    </>
  );

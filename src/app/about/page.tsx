  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-navy to-charcoal rounded-2xl p-10 flex flex-col gap-6">
              {[
                ...
                <div key={item.label} className="flex items-center gap-5 border-b border-slate-700 pb-6 last:border-0 last:pb-0">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {values.map((v) => (
              <div key={v.label} className="bg-slate-50 border border-slate-100 rounded-2xl p-6 text-center">
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-4">How We Work</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((step, i) => (
              <div key={step.label} className="relative bg-white border border-slate-100 rounded-2xl p-8 shadow-sm">
                <span className="absolute -top-4 left-8 w-8 h-8 bg-accent text-white text-sm font-bold rounded-full flex items-center justify-center">
                  {i + 1}
                </span>
                <h3 className="text-xl font-bold text-slate-900 mt-2 mb-3">{step.label}</h3>
